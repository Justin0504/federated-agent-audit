...
_DOMAIN_PATTERNS: dict[str, list[str]] = {
    "health": [
        ...
        r"\bcopay\b", r"\binsurer\b", r"\bpremium\b", r"\bdeductible\b",
        r"\bpharmacy\b", r"\breferral\b", r"\bwellness\b", r"\brehab",
    ],
    "finance": [
        ...
        r"\bbonus\b", r"\bequity\b", r"\b401k\b", r"\bpension\b",
        r"\bdividend\b", r"\bmortgage\b", r"\bloan\b", r"\binterest rate\b",
    ],
    "legal": [
        r"\blegal\b", r"\blawyer\b", r"\battorney\b", r"\bcourt\b",
        r"\bcontract\b", r"\blawsuit\b", r"\bcompliance\b", r"\bregulat",
        r"\bcustody\b", r"\bdivorce\b", r"\bnda\b", r"\bliability\b",
        r"\bsettlement\b", r"\bverdict\b", r"\barbitration\b",
    ],
    "identity": [
        ...
        r"\bfingerprint\b", r"\bphoto id\b", r"\bcitizenship\b",
    ],
    "schedule": [
