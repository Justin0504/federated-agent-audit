...
recipient principal accumulates $\geq k$ converging \texttt{inferred\_categories}
fragments about one subject, letting it infer a sensitive category it was never
authorized for; we score inference gain $1-2^{-k}$ and require $k\geq2$ so a single
incidental hint does not fire.
\end{enumerate}
