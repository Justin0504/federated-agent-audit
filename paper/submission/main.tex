...
the $K$ benign fragments it received ($K=1,2,3$). \emph{The threat is real and scales
with capability:} the LLM infers the withheld attribute (cancer, financial
distress, pregnancy, job search) from just 2 benign fragments in \textbf{3/4 cases
(gpt-4o-mini) and 4/4 (gpt-4o)} --- a stronger recipient infers more, so the
compositional threat grows as agents improve. \emph{Our detector is a
conservative, no-false-alarm lower bound:} every disagreement is an under-fire (the
attacker infers where we stay silent); we never fire where it cannot infer. Hence
detection must flag the metadata pattern, not try to out-infer the adversary. So $k^{*}=2$ with uniform evidence
...
\small
\bibitem{agentleak} F.\ El Yagoubi, G.\ Badu-Marfo, R.\ Al Mallah. AgentLeak: A
Benchmark for Internal-Channel Privacy Leakage in Multi-Agent LLM Systems.
arXiv:2602.11510, 2026.
\bibitem{sumleaks} V.\ Patil, E.\ Stengel-Eskin, M.\ Bansal. The Sum Leaks More
Than Its Parts: Compositional Privacy Risks and Mitigations in Multi-Agent
Collaboration. arXiv:2509.14284, 2025.
\bibitem{dpagents} Y.-T.\ Yang, Q.\ Zhu. Differential Privacy in Generative AI
Agents: Analysis and Optimal Tradeoffs. arXiv:2603.17902, 2026.
\bibitem{itlimits} S.\ Asif, M.\ Mohammadi Amiri. Information-Theoretic Privacy
Control for Sequential Multi-Agent LLM Systems. arXiv:2603.05520, 2026.
...
\bibitem{protosec} Y.\ Louck, A.\ Stulman, A.\ Dvir. Security Analysis of Agentic
AI Communication Protocols: A Comparative Evaluation. arXiv:2511.03841, 2025.
\bibitem{protoexploit} M.\,A.\ Ferrag et al. From Prompt Injections to Protocol
Exploits: Threats in LLM-Powered AI Agent Workflows. arXiv:2506.23260, 2025.
